...
//const pixeiscinzas = 0.21 * r + 0.72 * g + 0.07 * b;
//formula encontrada no youtube, gera uma imagem cinza mais... "viva"...
//não utilizada até compreender por que ela funciona.
...
function mudarradio(radio)
{
    ...
    {
        inputwebcam.style.display = "inline";
        inputarquivo.style.display = "none";
    }
    else 
    {
        inputwebcam.style.display = "none";
